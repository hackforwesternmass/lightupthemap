 ...
 */
function lightup_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['lightup_example'] = [
  '#type'          => 'checkbox',
  '#title'         => t('lightup sample setting'),
  '#default_value' => theme_get_setting('lightup_example'),
